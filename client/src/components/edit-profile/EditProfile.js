...
class CreateProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.profile.profile) {
      ...
      profile.numberofdogs = !isEmpty(profile.numberofdogs)
        ? profile.numberofdogs
        : "";
      ...
      this.setState({
        ...
        numberofdogs: profile.numberofdogs,
        bio: profile.bio,
            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <TextFieldGroup
                  ...
                  info="City, State preferred (eg: Denver, CO)"
                />
                ...
                <SelectListGroup
                  ...
                  info="How many dogs do you currently have"
                />
                ...
                <TextAreaFieldGroup
                  ...
                  onChange={this.onChange}
                  error={errors.bio}
                  info="Tell others a little about yourself"
                />
